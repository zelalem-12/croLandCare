...
let AdminNotificationComponent = class AdminNotificationComponent {
    ...
    ngOnInit() {
        ...
        this.authService.getAdminNotification(loggedUser.username).subscribe(data => {
...
let AuthService = class AuthService {
    ...
    getAdminNotification(admin) {
        const headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.get(`users/admin-notification/${admin}`, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
...
// AIzaSyCDF9nb_A3VLB5oOQDwFZGVWGKWqPmLiuI
